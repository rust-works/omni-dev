...
mod tests {
    ...
    async fn editmeta_cached_after_first_call() {
        ...
        assert!(first.fields.contains_key("customfield_10088"));
        assert!(second.fields.contains_key("customfield_10088"));
    }
    ...
    async fn editmeta_concurrent_refresh_shares_a_single_fetch() {
        ...
        assert!(a.fields.contains_key("customfield_10088"));
        assert!(b.fields.contains_key("customfield_10088"));
    }
}
